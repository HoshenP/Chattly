            ...
            {selected.map((option) => {
              return (
                <Badge
                  key={option.value}
                  className={cn(
                    "data-[disabled]:bg-muted-foreground data-[disabled]:text-muted data-[disabled]:hover:bg-muted-foreground bg-[#3aff7c] text-[#0A0A0A] p-2",
                ...
                >
                  ...
                  >
                    <X className="h-4 w-4 text-[#0A0A0A] hover:text-[#0A0A0A]" />
                  </button>
                </Badge>
              );
            })}
